...
func open(spot: String, chosen_price: int) -> bool:
	if is_open:
		return false
...
func can_sell_to(customer_type: String) -> Dictionary:
...
func sell_one(customer_type: String) -> Dictionary:
	var decision := can_sell_to(customer_type)
